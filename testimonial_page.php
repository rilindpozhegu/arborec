...
<section class="header_section_testimonial_p header_title_cover">
    <div class="container">
        <div class="row">
...
<section class="testimonial_section_what testimonial_section_what1">
    <div class="container">
        <div class="row">
        <h4>What Our Clients Say</h4>
            <div class="col-md-4">
                <img src="img/testimonial_man-01.png">
                <h5>Sacha Christe</h5>
